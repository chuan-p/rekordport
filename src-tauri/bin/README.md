...
- Apple Silicon 这组 sidecar 目前建议用 [tools/build-macos13-arm64-sidecars.sh](../../tools/build-macos13-arm64-sidecars.sh) 生成，默认把最低系统版本压到 macOS 13.0，并保留 `aac_at` / `libmp3lame` / `png`，这样转换时可以继续嵌入封面图。
